//
//  YHTransactionRecordsViewController.h
//  YHCustomer
//
...
@interface YHTransactionRecordsViewController : YHRootViewController<UITableViewDataSource,UITableViewDelegate , EGORefreshTableOtherDelegate>
{
