...
@implementation PSPatternEntity

@end
@implementation PSPatternObj
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         if (!error && jsonObject)
         {
             ...
             if (_uinet && [_uinet respondsToSelector:@selector(responseSuccessObj:nTag:)])
             {
                 ...
                 {
                     NSMutableArray * dataArray = [jsonObject objectForKey:@"data"];
                     if (dataArray && (dataArray != nil))
                     {
                         [_uinet responseSuccessObj:dataArray nTag:self._nApiTag];
                         return;
                     }
                 }
...
@implementation PSCountryStreetEntity

@end
@implementation PSCountryStreetObj
...
@implementation PSStreetSupermarketEntity

@end
@implementation PSStreetSupermarketObj
...
@implementation PSPickupSupermarketEntity

@end
@implementation PSPickupSupermarketObj
...
#pragma mark -----------517 new process 
@implementation BuCodeEntity

@end
@implementation BuCodeObj
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         if (!error && jsonObject)
         {
             ...
             {
                 NSMutableDictionary * dict = [jsonObject objectForKey:@"data"];
                 if (dict && (dict != nil))
                 {
         ...
         {
             [_uinet requestFailed:_nApiTag withStatus:@"0" withMessage:[PublicMethod changeStr:@"后台数据异常"]];
         }
     } failure:^(AFHTTPRequestOperation *operation, NSError *error)
     {
         if (_uinet && [_uinet respondsToSelector:@selector(requestFailed:withStatus:withMessage:)])
