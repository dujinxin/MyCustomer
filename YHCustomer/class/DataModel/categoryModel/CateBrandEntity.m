...
@implementation CateBrandEntity
@synthesize bu_category_id,category_name,icon;
@end


@implementation CateNetTransObj
/*
...
-(BOOL) oldresponseSuccess:(ASIHTTPRequest *)request{
    ...
    if([status isEqualToString:WEB_STATUS_1] ){
        for (NSDictionary *dic in datas) {
            CateBrandEntity *goodsList = [[CateBrandEntity alloc] init];
            goodsList.bu_category_id = [dic objectForKey:@"bu_category_id"];
            goodsList.category_name = [dic objectForKey:@"category_name"];
            goodsList.bu_brand_id = [dic objectForKey:@"bu_brand_id"];
            goodsList.brand_name = [dic objectForKey:@"brand_name"];
        ...
        for (NSDictionary *dic in datas) {
            ...
            if ([goodsList.has_son isEqualToString:@"1"]) {
                ...
                for (NSDictionary * d in childArray) {
                    CateBrandEntity *childList = [[CateBrandEntity alloc] init];
