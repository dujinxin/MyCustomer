...
{
    NSString *localPath = [diskCachePath stringByAppendingPathComponent:@""];
...
//    NSString *key = [info objectForKey:@"key"];
    ...
    NSString *localPath = [diskCachePath stringByAppendingPathComponent:@""];
    NSData *localData = UIImageJPEGRepresentation(image, 0.5f);
