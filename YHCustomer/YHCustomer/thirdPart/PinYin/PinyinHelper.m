...
+ (NSString *)toHanyuPinyinStringWithNSString:(NSString *)str
    ...
    if ([resultPinyinStrBuf isEqualToString:@"zhongqing"]) {
        resultPinyinStrBuf = (NSMutableString *)@"chongqing";
    }
    if ([resultPinyinStrBuf isEqualToString:@"shamen"]) {
        resultPinyinStrBuf = (NSMutableString *)@"xiamen";
    }
