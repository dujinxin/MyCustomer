...
@implementation BindCardEntity

@end
@implementation BindCardNetTransObj
             ...
             if (_uinet && [_uinet respondsToSelector:@selector(responseSuccessObj:nTag:)])
             {
                 ...
                 else if ([status isEqualToString:@"1"])
                 {
                     ...
                     else
                     {
                         ...
                         BindCardEntity *entity = [[BindCardEntity alloc]init];
                         for (NSDictionary *dic in datas)
                         {
                             ...
                             if (bind_card_list.count != 0)
                             {
                                 ...
                                 {
                                     BindCardEntity *entity2 = [[BindCardEntity alloc]init];
                             ...
                             if (no_bind_card_list.count != 0)
                             {
                                 for (NSMutableDictionary *dic_no_bind_list in no_bind_card_list) {
                                     BindCardEntity *entity3 = [[BindCardEntity alloc]init];
