//
//  CardBindStatusEntity.m
//  YHCustomer
//
//  Created by wangliang on 15-4-9.
//  Copyright (c) 2015年 富基融通. All rights reserved.
//

#import "CardBindStatusEntity.h"

@implementation CardBindStatusEntity

@end
@implementation CardBindStatusNetTransObj
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         if (!error && jsonObject)
         {
             ...
             if (_uinet && [_uinet respondsToSelector:@selector(responseSuccessObj:nTag:)])
             {
                 ...
                 {
                     NSMutableDictionary * dic = [jsonObject objectForKey:@"data"];
                     if (!dic || (dic == nil))
                     {
                     ...
                     {
                         CardBindStatusEntity *entity = [[CardBindStatusEntity alloc]init];
                        
                             entity.bind_status = [dic objectForKey:@"bind_status"];
