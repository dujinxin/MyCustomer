...
#import "UserBindCardEntity.h"

@implementation UserBindCardEntity
@synthesize status;
@end
@implementation UserBindCardTrans
...
-(BOOL) responseSuccess:(ASIHTTPRequest *)request{
    ...
    NSLog(@"request.responseString is %@",request.responseString);
