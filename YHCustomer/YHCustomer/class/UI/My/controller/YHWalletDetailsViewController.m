//
//  YHWalletDetailsViewController.m
//  YHCustomer
//
...
@interface YHWalletDetailsViewController ()
{
//    UIView *headView;
    int pages;
...
@end
@implementation YHWalletDetailsViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = @"永辉钱包账户详情";
...
//    [self.view addSubview:headView];
    ...
    UILabel *cardLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, 0, SCREEN_WIDTH, 30)];
    ...
    CGFloat aa = [entityCard.amount floatValue];
...
//    moneyLabel.textColor = [PublicMethod colorWithHexValue1:@"#FC5860"];
    ...
    UILabel *stateLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, moneyLabel.bottom, SCREEN_WIDTH, 30)];
    NSString *str1;
    ...
    UILabel *bgLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, stateLabel.bottom, SCREEN_WIDTH, 10)];
