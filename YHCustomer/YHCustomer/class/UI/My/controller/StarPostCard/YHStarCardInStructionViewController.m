//
//  YHStarCardInStructionViewController.m
//  YHCustomer
//
...
@interface YHStarCardInStructionViewController ()

@end

@implementation YHStarCardInStructionViewController

- (void)viewDidLoad
{
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor whiteColor];
    self.navigationItem.title = @"星级包邮卡说明";
...
-(void)loadRequest
{
    ...
    url = [NSString stringWithFormat:@"%@v1/page/service_info?type=8",BASE_URL];
